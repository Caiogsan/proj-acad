      ...
      <div className="w-[60%] flex flex-col">
        <div className="h-[80%] p-4">
          <h1 className="text-xl sm:text-2xl font-bold">
            Horarios de funcionamentos:
          </h1>
          <p className="text-md sm:text-lg pt-4 font-bold font-serif">
            Segunda a sexta:
          </p>
        ...
        <p className="h-[20%] font-serif flex items-end p-4 text-[10px]">
          Horários podem estar sujeitos a mudanças, dias de feriado e recessões
