function TimesSlide(){
    return (
        <div className="m-auto bg-gray-200 mb-10 w-[80%] flex rounded h-[30rem] xl:h-[40rem] 2xl:h-[45rem] justify-center">
            ...
            <div className="w-[40%] rounded bg-fundo1 bg-cover bg-center">.
            </div>
        </div>
    )
}
