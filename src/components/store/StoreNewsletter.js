function StoreNewsLetter() {
  return (
    <div className="bg-gray-50 py-20 mb-10 px-6 mx-4">
      ...
      <h2 className="text-center font-most text-gray-500">
        Assine a NLife e receba conteúdos valiosos sobre nutrição,
        suplementação, estilo de vida e exercícios físicos
      </h2>
      <form className="flex mt-10 w-[30%] gap-2 m-auto flex-col">
        <label htmlFor="name" className="font-most text-gray-800 text-sm">
          Nome:
        </label>
        <input
          id="name"
          ...
          type="text"
        ></input>
        <label htmlFor="email" className="font-most text-gray-800 text-sm">
          Email:
        </label>
        <input
          id="email"
          className="bg-gray-100 rounded border-[1px] p-1 h-9 border-gray-300 shadow-inner"
          type="email"
        ></input>
        <label htmlFor="options" className="font-most text-gray-800 text-sm">
          Qual seu interesse?
        </label>
        <select
          id="options"
        ...
        <div className="flex gap-2 my-2 items-center">
          ...
          <label htmlFor="info" className="text-sm">
            Eu concordo em receber informações do site.
          </label>
        </div>
        <a className="font-most mb-4 text-gray-800 text-xs underline" href="/">
          Política de Privacidade
        </a>
        <button className="bg-black text-white rounded-full h-10" type="submit">
          ENVIAR
        </button>
      </form>
      <p className="w-[38%] mt-6 text-gray-500 font-info m-auto">
        A NUPRATA se preocupa com a sua privacidade! Utilizamos seus dados
        apenas para enviar nossas novidades e promoções. Ao assinar nossa
        Newsletter, você concorda com a nossa Política de Privacidade.
      </p>
    </div>
  );
}
